...
export function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className={cn("min-h-[100dvh] flex flex-col bg-background relative max-w-md mx-auto shadow-2xl shadow-black/5 overflow-x-hidden ring-1 ring-border/50", !isSos && !isZakiy && "pb-[80px]")}>
